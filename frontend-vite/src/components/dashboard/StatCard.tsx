    ...
    <Card className="group overflow-hidden border-none bg-white shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-2xl">
      <CardContent className="p-6">
        ...
        <div className="space-y-1">
          <h3 className="text-3xl font-black text-[#2D1B08] tracking-tighter">{value}</h3>
          <p className="text-[10px] font-black text-[#5D4037]/50 uppercase tracking-[0.2em]">{label}</p>
        </div>
